...
class SphereEvenlySampling(Process):
    ...
    def __init__(self, analysis):
        ...
        logging.info('preparing graph/point cloud')
        ...
        logging.info('base graph is ready')
        if self.dataset_is_graph:
    ...
    def run(self):
        ...
        logging.info('generate preview gif')
        self.make_base_preview_image()

        logging.info('run base R')
        self.run_base_r()
    ...
    def make_base_preview_image(self):
        ...
        anim = animation.FuncAnimation(fig, animate, init_func=init,
                                       frames=30, repeat_delay=1000)

        anim.save(image_file_path, writer='imagemagick', fps=6, dpi=96)
        plt.close()
