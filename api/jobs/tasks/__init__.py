...
from jobs.utils.job import job_prepare_work_dir, job_download_data_file, job_get
...
def dispatch_computing(job_id):
    ...
    job_download_data_file(job.param('file'), data_file_path)
...
#
#     work_dir = job_prepare_work_dir(job, ticket)
#     base_coordinates_file = job_download_data_file(work_dir, job.inputs['file'])
#
